testthat::test_that('Check if the snapshots do not change', {
  ...
  # IMPORTANT: If one of the snapshot test fails, the rest gets deleted.
  # CHANGE logic: should have a helper function that writes the snapshot test file with all the available files...
