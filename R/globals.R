...
utils::globalVariables(c(".", 
                         "alternative responses", "CRTMCQ4_Reflectiveness_DIRd", "Código", "Test", "DIFF", "Descripcion", "EMAIL",
"NAMES", "N_responses", "Nombre", "ProgressReporter", "RAW", "REI40_Experiential_DIRd",
"Responses", "TEXT", "TIME", "alternative",
"responses", "bold_labels", "button_pressed", "canonical",
"citas",  "col_red", "condition_within", "condition_withinOK", "Código Test",
...
"rt", "safely", "scale_fill_gradientn", "scale_fill_manual", "scale_x_date",
...
"time_elapsed",  "trial_type", "trialid", "type", "value"))
