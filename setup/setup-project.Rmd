...
<span style="color:orange">Creating necessary folders</span>:  data, outputs/data, outputs/plots, outputs/tables, outputs/tests_outputs, .vault, .vault/outputs/data, .vault/data_vault_5, .vault/data_vault_6 
