...
##' Things to change: 
##'   - Name of function: prepare_ACE -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_ACE <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_ACE)
  ...
  items_dimensions = list(
    MalosTratos = c("001", "002", "003", "004", "005"),
    DisfuncionHogar = c("006", "007", "008", "009", "010")
  )
