...
##' Things to change: 
##'   - Name of function: prepare_DEMOGR45 -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_DEMOGR45
##'
...
prepare_DEMOGR45 <- function(DF_clean, short_name_scale_str, output_formats) {
  ...
  # jsPsychHelpeR::debug_function(prepare_DEMOGR45)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
         trialid == "DEMOGR45_001" ~ RAW,
         
         trialid == "DEMOGR45_002" & RAW == "Femenino" ~ "0",
         trialid == "DEMOGR45_002" & RAW == "Masculino" ~ "1",
         
          trialid == "DEMOGR45_003" & RAW == "Bajo (Primaria o Secundaria)" ~ "1",
          trialid == "DEMOGR45_003" & RAW == "Medio (Estudios formativas profesionales)" ~ "2",
          trialid == "DEMOGR45_003" & RAW == "Alto (estudios superiores)" ~ "3",
