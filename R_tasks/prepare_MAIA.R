...
##' Things to change: 
##'   - Name of function: prepare_MAIA -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_MAIA <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_MAIA)
