...
##' Things to change: 
##'   - Name of function: prepare_CSI -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_CSI <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_CSI)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
         RAW == "En el último mes" ~ 1,
         RAW == "Al menos en estos 6 meses" ~ 2,
         RAW == "Al menos durante todo el último año" ~ 3,
         RAW == "Hace más de un año" ~ 4,
         RAW == "Por lo menos 10 o más años" ~ 5,
