...
##' Things to change: 
##'   - Name of function: prepare_ERSQ -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_ERSQ <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_ERSQ)
  ...
  items_dimensions = list(
    Awareness = c("001", "012", "019"),
    Sensations = c("007", "014", "024"),
    Clarity = c("006", "013", "025"),
    Understanding = c("003", "011", "020"),
    Acceptance = c("017", "005", "023"),
    Tolerance = c("004", "018", "026"),
    SelfSupport = c("027", "009", "015"),
    Confront = c("008", "016", "022"),
    Modification = c("002", "010", "021")
  )
