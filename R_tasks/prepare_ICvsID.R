...
##' Things to change: 
##'   - Name of function: prepare_ICvsID -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_ICvsID
##'
...
##' @author gorkang
##' @export
prepare_ICvsID <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_ICvsID)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
          trialid %in% paste0(short_name_scale_str, "_", items_dimensions |> unlist()) ~ RAW,
