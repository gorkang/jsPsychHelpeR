...
##' Things to change: 
##'   - Name of function: prepare_LASSI38 -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_LASSI38
##'
...
##' @author gorkang
##' @export
prepare_LASSI38 <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_LASSI38)
  ...
  items_to_reverse = c("002", "005", "006", "007", "010", "011", "012", "013", "014", "015", "016", "018", "020", "021", "023", "024", "025", "029", "030", "032", "033", "034", "035")
  
  ## NameDimension1, NameDimension2 should be the names of the dimensions
  ## Inside each c() create a vector of the item numbers for the dimension
  ## Add lines as needed. If there are no dimensions, keep as is
  items_dimensions = list(
    EstrategiasMotivacionalesActitudinales = c("002", "005", "006", "014"),
    TecnicasSeleccionOrganizacionInformacion = c("008", "018", "025", "026", "029", "030", "031"),
    DificultadesSeleccionOrganizacionElaboracionInformacion = c("023", "024", "035", "036", "038"),
    AprendizajeSignificativo = c("017", "019", "020", "021", "022"),
    EstrategiasAutoevaluacionAprendizaje = c("027", "028", "032", "033", "034", "037"),
    EsfuerzoAspiracionesAcademicas = c("001", "003", "004", "013"),
    DificultadesOrganizacionTiempoAprendizaje = c("007", "009", "010", "011", "012", "015", "016", "017")
  )
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
         RAW == "No es una característica mía" ~ 0,
         RAW == "No es una característica muy común en mí" ~ 1,
         RAW == "Algo o un poco característico mío" ~ 2,
         RAW == "Con frecuencia es una característica mía" ~ 3,
         RAW == "Algo muy característico mío" ~ 4,
