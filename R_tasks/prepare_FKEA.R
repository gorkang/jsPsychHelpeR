...
##' Things to change: 
##'   - Name of function: prepare_FKEA -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_FKEA <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # debug_function(prepare_FKEA)
