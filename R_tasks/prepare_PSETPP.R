...
##' Things to change: 
##'   - Name of function: prepare_PSETPP -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_PSETPP
##'
...
##' @author gorkang
##' @export
prepare_PSETPP <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_PSETPP)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
          # RAW == "Muy de acuerdo" ~ 6,
          # RAW == "Parcialmente de acuerdo" ~ 5,
          # RAW == "De acuerdo" ~ 4,
          # RAW == "Parcialmente en desacuerdo" ~ 3,
          # RAW == "En desacuerdo" ~ 2,
