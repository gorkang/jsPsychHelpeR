##' Prepare APrioriDiagnostic
##'
##' Template for the functions to prepare specific tasks. Most of this file should not be changed
##' Things to change: 
##'   - Name of function: prepare_APrioriDiagnostic -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_APrioriDiagnostic
##'
...
##' @author gorkang
##' @export
prepare_APrioriDiagnostic <- function(DF_clean, short_name_scale_str, output_formats) {
  
  # DEBUG
  # targets::tar_load_globals()
  # debug_function(prepare_APrioriDiagnostic)
