...
##' Things to change: 
##'   - Name of function: prepare_MLQ -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_MLQ <- function(DF_clean, short_name_scale_str) {

  # DEBUG
  # debug_function(prepare_MLQ)
  ...
  items_dimensions = list(
    InfluenAtrib = c("10", "25", "40", "22", "23"),
    InfluenComp = c("06", "21", "24", "38"),
    Motivacion = c("09", "13", "14", "26", "42", "44"),
    ConsIndiv = c("11", "15", "19", "29"),
    EstimIntel = c("08", "30", "31", "32")
  )
