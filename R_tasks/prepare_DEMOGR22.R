...
##' @author gorkang
##' @export
prepare_DEMOGRfondecyt2022E1 <- function(DF_clean, short_name_scale_str) {

  # DEBUG
  # debug_function(prepare_DEMOGRfondecyt2022E1)
  ...
  names_dimensions = c("age", "gender") # If no dimensions, keep names_dimensions = c("")
