...
##' @author gorkang
##' @export
prepare_AIM23 <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # debug_function(prepare_AIM23)
  ...
  dplyr::mutate(
    DIR =
     dplyr::case_when(
        ...
        RAW == "Primaria completa; primaria o preparatoria completa." ~ "3",
        RAW == "Secundaria incompleta; humanidades incompletas." ~ "4",
        RAW == "Secundaria completa; humanidades completas." ~ "5",
        RAW == "Técnico incompleto (carreras de 1 a 3 años)." ~ "6",
        RAW == "Técnico completo (carreras de 1 a 3 años)." ~ "7",
        RAW == "Universitaria incompleta (carreras de 4 o más años)." ~ "8",
        RAW == "Universitaria completa (carreras de 4 o más años)." ~ "9",
        ...
        RAW == 'Menos de 1 salario mínimo' ~ "1",
        RAW == 'Entre 1 salario mínimo y 2 salarios mínimos' ~ "2",
        RAW == 'Entre 2 salario mínimo y 4 salarios mínimos' ~ "3",
        RAW == 'Entre 4 salario mínimo y 6 salarios mínimos' ~ "4",
        RAW == 'Más de 6 salarios mínimos' ~ "5",
        RAW == 'NS/NR' ~ "99",
