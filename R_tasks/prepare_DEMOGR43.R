...
##' Things to change: 
##'   - Name of function: prepare_DEMOGR43 -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_DEMOGR43
##'
...
##' @author gorkang
##' @export
prepare_DEMOGR43 <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_DEMOGR43)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
         trialid == "DEMOGR43_001" ~ RAW,
         
         trialid == "DEMOGR43_002" & RAW == "Femenino" ~ "0",
         trialid == "DEMOGR43_002" & RAW == "Masculino" ~ "1",
         
          trialid == "DEMOGR43_003" & RAW == "Bajo (Primaria o Secundaria)" ~ "1",
          trialid == "DEMOGR43_003" & RAW == "Medio (Estudios formativas profesionales)" ~ "2",
          trialid == "DEMOGR43_003" & RAW == "Alto (estudios superiores)" ~ "3",
