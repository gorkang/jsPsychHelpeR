...
##' Things to change: 
##'   - Name of function: prepare_DEMOGR29 -> prepare_[value of short_name_scale_str] 
##'   - dimensions parameter in standardized_names()
##'   - 2 [ADAPT] chunks
##'
##' @title prepare_DEMOGR29
##'
...
##' @author gorkang
##' @export
prepare_DEMOGR29 <- function(DF_clean, short_name_scale_str) {

  # DEBUG
  # targets::tar_load_globals()
  # debug_function(prepare_DEMOGR29)
  ...
  # ****************************************************************************
    ...
    # 1 DEMOGR29_01 How old are you?                                                    
    # 2 DEMOGR29_02 Are you currently located in USA?                                   
    # 3 DEMOGR29_04 To which gender identity do you most identify?                      
    # 4 DEMOGR29_05 Are you of Hispanic, Latino, or Spanish origin?                     
    # 5 DEMOGR29_06 How do you describe your ethnicity?                                 
    # 6 DEMOGR29_07 What is the highest degree or level of education you have completed?
    # 7 DEMOGR29_08 What was your area of study?                                        
    # 8 DEMOGR29_09 What is your current employment status?                             
    # 9 DEMOGR29_10 What is your annual household income?   
