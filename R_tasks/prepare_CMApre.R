...
##' @author gorkang
##' @export
prepare_CMApre <- function(DF_clean, short_name_scale_str) {
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
          trialid == "CMApre_01" & RAW == "Poor" ~ 1,
          trialid == "CMApre_01" & RAW == "Fair" ~ 2,
          trialid == "CMApre_01" & RAW == "Good" ~ 3,
          trialid == "CMApre_01" & RAW == "Very good" ~ 4,
          trialid == "CMApre_01" & RAW == "Excellent" ~ 5,
          
          trialid == "CMApre_02" & RAW == "Worse" ~ -1,
          trialid == "CMApre_02" & RAW == "Same" ~ 0,
          trialid == "CMApre_02" & RAW == "Better" ~ 1,
