...
##' Things to change: 
##'   - Name of function: prepare_ISP -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_ISP <- function(DF_clean, short_name_scale_str) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_ISP)
  ...
  # ****************************************************************************
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
          RAW == "nunca o casi nunca" ~ 0,
          RAW == "pocas veces" ~ 1,
          RAW == "a veces si y a veces no" ~ 2,
          RAW == "muchas veces" ~ 3,
          RAW == "siempre o casi siempre" ~ 4,
