...
##' Things to change: 
##'   - Name of function: prepare_AASR -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_AASR <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_AASR)
  ...
  items_to_reverse = c("002", "007", "008", "012", "013", "016", "017", "018")
  
  ## NameDimension1, NameDimension2 should be the names of the dimensions
  ## Inside each c() create a vector of the item numbers for the dimension
  ## Add lines as needed. If there are no dimensions, keep as is
  items_dimensions = list(
    Cercania = c("001", "006", "008", "012", "013", "017"),
    Dependencia = c("002", "005", "007", "014", "016", "018"),
    Ansiedad = c("003", "004", "009", "010", "011", "015")
  )
