...
##' @author gorkang
##' @export
prepare_PRFBM <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_PRFBM)
    ...
    dplyr::mutate(
      DIR =
       dplyr::case_when(
          ...
          # trialid == "PRFBM_03" ~ -as.numeric(RAW),
          ...
          trialid != "PRFBM_01" ~ as.numeric(RAW),
