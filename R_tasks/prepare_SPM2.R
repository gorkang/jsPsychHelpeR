...
##' Things to change: 
##'   - Name of function: prepare_SPM2 -> prepare_[value of short_name_scale_str] 
...
##' @author gorkang
##' @export
prepare_SPM2 <- function(DF_clean, short_name_scale_str, output_formats) {

  # DEBUG
  # targets::tar_load_globals()
  # jsPsychHelpeR::debug_function(prepare_SPM2)
  ...
  items_to_reverse = c("052", "071", "072", "073", "074", "077")
